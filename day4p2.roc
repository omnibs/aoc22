...
overlap = \list ->
    when list is
        [a, b] ->
            ...
            #   |--|
            # |--|
            a.first <= b.first && a.last >= b.first || b.first <= a.first && b.last >= a.first

        _ -> crash "cant happen"

expect overlap [{ first: 1, last: 2 }, { first: 1, last: 2 }]
expect overlap [{ first: 1, last: 10 }, { first: 9, last: 10 }]
expect overlap [{ first: 2, last: 2 }, { first: 1, last: 10 }]
expect overlap [{ first: 1, last: 3 }, { first: 2, last: 10 }]
expect overlap [{ first: 2, last: 10 }, { first: 1, last: 3 }]
